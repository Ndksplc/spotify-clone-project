...
export const supabaseAdmin = createClient<Database>(process.env.NEXT_PUBLIC_SUPABASE_URL || '',
...
const copyBillingDetailsToCustomer = async(uuid: string,
...
const manageSubscriptionStatusChange = async(
  ...
  console.log(`Inserted/ Updated suscription [${subscription.id} for ${uuid}]`);
