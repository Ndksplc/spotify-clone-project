...
const PlayerContent:React.FC<PlayerContentProps>=({song,songUrl}) =>{
  ...
  <div className="grid grid-cols-2 md:grid-cols-3 h-full">
    ...
    <div className="hidden md:flex h-full w-full justify-center items-center max-w-[722px] gap-x-6">
        ...
        <div onClick={handlePlay} className="flex justify-center items-center w-10 h-10
      ...
      <div className="hidden md:flex w-full h-full justify-end pr-2">
        <div className="flex items-center gap-x-2 w-[120px]">
          <VolumIcon onClick={toggleMute} className="cursor-pointer" 
          size={20}/>
          <Slider value={volume} 
